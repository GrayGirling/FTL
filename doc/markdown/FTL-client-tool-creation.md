...
| parsew\_item(ref\_line, delims, ndelims, buf, len);               | true iff there is a non-empty item of non-delimiter characters - which are placed in the buffer provided                                                                                                                                                 |
